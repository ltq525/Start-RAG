...
class QdrantVectorStore:
    ...
    def search_similar(
        ...
        try:
            ...
            try:
                ...
                search_params = None
            # 旧版 会出现ERROR:hello_agents.memory.storage.qdrant_store:❌ 向量搜索失败: 'QdrantClient' object has no attribute 'search'
    ...
    def get_collection_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # 处理嵌套结构的兼容性
            if not vectors_count and hasattr(collection_info, 'vectors_count'):
